...
import com.orange.signsatwork.biz.storage.UploadVideoToDailymotionService;
...
public class FileUploadRestController {
  ...
  private String handleRecordedVideoFile(VideoFile videoFile, OptionalLong requestId,OptionalLong signId, OptionalLong videoId, Principal principal, HttpServletResponse response) {
    ...
    try {
      ...
      // Dailymotion
      UploadVideoToDailymotionService uploadToDailymotion = new UploadVideoToDailymotionService(services, springRestClient, this,
