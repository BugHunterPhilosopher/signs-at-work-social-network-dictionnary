...
public class SignServiceDeleteTest {
  ...
  public void canRemoveSign() {
    ...
    Sign sign1 = services.sign().create(user.id, "sign-canRemoveSign", "//video-canRemoveSign", "", MediaType.LSF.toString());
    Sign sign2 = services.sign().create(user.id, "sign-canRemoveSign2", "//video-canRemoveSign2", "", MediaType.LSF.toString());
