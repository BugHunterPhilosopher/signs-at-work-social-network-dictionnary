...
public class SignRepositoryIntegrationTest {
  ...
  public void returnAllPersisted() throws IOException {
    // given
    entityManager.persist(new SignDB(sign1Name, sign1Url, new Date(), null, null, null, null));
    entityManager.persist(new SignDB(sign2Name, sign2Url, new Date(), null, null, null, null));
